...
const routes = application => {
  return new Promise(resolve => {
    ...
    */
     ...
     * @param {object} next - Express callback
    */
    app.get(`/${config.users.base}/${config.users.actions.edit}/:id`, acl.middleware(1, getUserId, 'update'), (req, res, next) => {
      let user;
    ...
    */
     ...
     * @param {object} next - Express callback
    */
    app.get(`/${config.users.base}/${config.users.actions.delete}/:id`, acl.middleware(1, getUserId, 'delete'), (req, res, next) => {
      // turnd off eslint: should be allowed to change req.session
