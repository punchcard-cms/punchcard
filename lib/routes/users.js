...
const routes = application => {
  return new Promise(resolve => {
    ...
    */
     ...
     * @param {object} next - Express callback
    */
    app.post('/users/add', multipartMiddleware, (req, res, next) => {
      const data = {
     ...
     * @param {object} next - Express callback
    */
    app.get('/users/edit/:id', (req, res, next) => {
      let user;
     ...
     * @param {object} next - Express callback
    */
    app.post('/users/edit/', multipartMiddleware, (req, res, next) => {
      const data = {
        email: req.body['email--email'],
        role: req.body['role--select'],
      };
    ...
    */
     ...
     * @param {object} next - Express callback
    */
    app.post('/users/delete', multipartMiddleware, (req, res, next) => {
